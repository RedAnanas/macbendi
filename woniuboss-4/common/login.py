...
class public_Login:
    ...
    def second_manager(self):
        self.driver.find_element_by_name('userName').clear()
        self.driver.find_element_by_name('userName').send_keys('WNCD002')
        self.other_same_login()
    #使用咨询主管登录系统
    def question_manager(self):
        self.driver.find_element_by_name('userName').clear()
        self.driver.find_element_by_name('userName').send_keys('WNCD011')
        self.other_same_login()
    #使用咨询师登录系统.
    def teach_manager(self):
        self.driver.find_element_by_name('userName').clear()
        self.driver.find_element_by_name('userName').send_keys('WNCQ023')
        self.other_same_login()
    def diff_account(self,username):
        self.driver.find_element_by_name('userName').click()
        self.driver.find_element_by_name('userName').clear()
